<template>
    <div style="width: 700px; margin: 0 auto;">
        <h3 class="alignC">HTRemote</h3>
        <h4>Privacy policy</h4>
        <p>This privacy policy governs your use of the software application HTRemote (“Application”) for mobile devices that was created by Igor Silakov. Application is an app for remote control of Media Player Classic - Home Cinema.</p>
        ...
        <h5>Contact us</h5>
        <p>If you have any questions regarding privacy while using the Application, or have questions about our practices, please contact us via email at <a href="mailto:kaluganin514@gmail.com">kaluganin514@gmail.com</a>.</p>
    </div>
</template>